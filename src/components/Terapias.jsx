  ...
  return (
    <div className="terapiasContainer" >
      ...
      <p className="terapiasIntro terapiasTop">
        ...
        tratamientos.<br className='brTerapias'/> Contamos con un equipo terapéutico interdisciplinario
        altamente capacitado, conformado por psicólogos, psiquiatras, médicos,
        docentes, trabajadores sociales,<br className='brTerapias'/> operadores socio-terapéuticos,
      ...
      <p className="terapiasIntro" id='contacto'>
        ...
        los cambios en la actitud de la familia<br className='brTerapias'/> favorecerán el progreso de los
